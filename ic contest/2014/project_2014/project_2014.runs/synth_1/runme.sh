...
HD_PWD='C:/Users/611B/Desktop/1/project_2014/project_2014.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log STI_DAC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source STI_DAC.tcl
